...
class _Oval28Clipper extends CustomClipper<Rect> {
  const _Oval28Clipper();
...
final oval28 = GearDefinition(
  ...
  holes: [
    ...
    GearHole(name: '8', angle: 1.5707963310991675, distance: 7.833333345411331),
    GearHole(name: '9', angle: 2.369462026202007, distance: 8.882930710810744),
    GearHole(
    ...
    GearHole(
        name: '14', angle: -0.011904198724384871, distance: 14.000991994486737),
    GearHole(
        name: '15', angle: 0.777479371858356, distance: 14.882615476077817),
    GearHole(
        name: '18', angle: -3.1323336596159552, distance: 18.000771622004322),
    GearHole(
        name: '22', angle: -0.007575612113837139, distance: 22.000631270266158),
  ],
  isRing: false,
  isRound: false,
  ...
  ovalClipper: const _Oval28Clipper(),
  pathClipper: null,
);
